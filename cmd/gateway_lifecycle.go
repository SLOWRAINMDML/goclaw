...
func (d *gatewayDeps) runLifecycle(
	...
	go consumeInboundMessages(ctx, d.msgBus, d.agentRouter, d.cfg, deps.sched, d.channelMgr, deps.consumerTeamStore, deps.quotaChecker, d.pgStores.Sessions, d.pgStores.Agents, d.pgStores.Tenants, d.providerRegistry, contactCollector, d.pgStores.SystemConfigs, deps.postTurn, deps.subagentMgr)
